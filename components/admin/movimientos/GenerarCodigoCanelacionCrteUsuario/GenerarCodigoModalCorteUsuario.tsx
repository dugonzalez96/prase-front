import { getGenerarCodigoCortesUsuario } from "@/actions/CorteDelDiaActions";
...
export default function GenerarCodigoModalCorteUsuario({ abierto, alCerrar }: PropiedadesGenerarCodigo) {
    ...
    const generarCodigo = async () => {
        ...
        startTransition(async () => {
            try {
                const respuesta = await getGenerarCodigoCortesUsuario(Number(idTransaccion));
